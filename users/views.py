...
from .forms import CustomUserCreationForm ,ProfileForm , MessageForm , SkillForm # like model forms . crating instance of form
...
def loginUser(request):
    ...
    if request.method == 'POST':
        ...
        if user is not None:
            # creating user session if it exists.
            login(request,user)
